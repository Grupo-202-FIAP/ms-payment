...
//        }
//
//        final Order order = new Order() ; // = orderRepositoryPort.findByIdentifier(event.getData().getExternalReference());
//        if (order == null) {
...
//        logger.info("[Webhook][Payment] Order updated to authorized status: {}", order.getId());
    }
